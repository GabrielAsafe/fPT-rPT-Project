...
{
	{ "Normal Attack", 0x11111111, "Skill_Normal" },

	//Mechanician Skills - Tier 1
	{ "Extreme Shield", SKILLID_ExtremeShield, "TM10 Ex_shield", "Mc1_E_SHIELD.tga" },
	{ "Mechanic Bomb", SKILLID_MechanicBomb, "TM12 M_bomb" },
	{ "Poison Attribute", SKILLID_PoisonAttribute, "TM14 P_attribute" },
	{ "Physical Absorption", SKILLID_PhysicalAbsorb, "TM17 Ph_absorb", "Mc1_P_ABSORB.tga" },

	//Tier 2
	{ "Great Smash", SKILLID_GreatSmash, "TM20 G_Smash" },
	{ "Maximize", SKILLID_Maximize, "TM23 Maximize", "Mc2_MAXIMIZE.tga" },
	{ "Automation", SKILLID_Automation, "TM26 Automation", "Mc2_AUTOMATION.tga" },
	{ "Spark", SKILLID_Spark, "TM30 Spark" },

	//Tier 3
	{ "Metal Armor", SKILLID_MetalArmor, "TM40 M_Armor", "Mc3_M_ARMOR.tga" },
	{ "Grand Smash", SKILLID_GrandSmash, "TM43 Grand_Smash" },
	{ "Mechanic Weapon Mastery", SKILLID_MechanicWeaponMastery, "TM44 M_Weapon" },
	{ "Spark Shield", SKILLID_SparkShield, "TM50 S_Shield", "Mc3_S_SHIELD.tga" },

	//Tier 4
	{ "Impulsion", SKILLID_Impulsion, "TM60 Impulsion" },
	{ "Compulsion", SKILLID_Compulsion, "TM63 Compulsion", "Mc4_COMPULSION.tga" },
	{ "Magnetic Sphere", SKILLID_MagneticSphere, "TM66 M_Sphere", "Mc4_M_SPHERE.tga" },
	{ "Metal Golem", SKILLID_MetalGolem, "TM70 M_Golem", "Mc4_M_GOLEM.tga" },

	//Tier 5
	{ "Rupture", SKILLID_Rupture, "TM100 Rupture" },
	{ "Magnetic Discharge", SKILLID_MagneticDischarge, "TM103 Magnetic_Discharge" },
	{ "Hardened Ward", SKILLID_HardeningShield, "TM106 Hardening_Shield" },
	{ "Swarm Shot", SKILLID_ParasitShot, "TM110 Parasit_Shot" },

	//Fighter Skills - Tier 1
	{ "Melee Mastery", SKILLID_MeleeMastery, "TF10 M_mastery" },
	{ "Fire Attribute", SKILLID_FireAttribute, "TF12 F_attribute" },
	{ "Raving", SKILLID_Raving, "TF14 raving" },
	{ "Impact", SKILLID_Impact, "TF17 impact" },

	//Tier 2
	{ "Triple Impact", SKILLID_TripleImpact, "TF20 T_Impact" },
	{ "Brutal Swing", SKILLID_BrutalSwing, "TF23 B_Swing" },
	{ "Roar", SKILLID_Roar, "TF26 Roar" },
	{ "Rage of Zecram", SKILLID_RageofZecram, "TF30 R_Zecram" },

	//Tier 3
	{ "Concentration", SKILLID_Concentration, "TF40 Concentration", "Ft3_CONCENTRATION.tga" },
	{ "Avenging Crash", SKILLID_AvengingCrash, "TF43 A_Crash" },
	{ "Swift Axe", SKILLID_SwiftAxe, "TF46 S_Axe", "Ft3_S_AXE.tga" },
	{ "Bone Crash", SKILLID_BoneCrash, "TF50 B_Crash" },

	//Tier 4
	{ "Destroyer", SKILLID_Destroyer, "TF60 Destoryer" },
	{ "Berserker", SKILLID_Berserker, "TF63 Berserker", "Ft4_BERSERKER.tga" },
	{ "Cyclone Strike", SKILLID_CycloneStrike, "TF66 C_Strike" },
	{ "Boost Health", SKILLID_BoostHealth, "TF70 B_Health" },

	//Tier 5
	{ "Survival Instinct", SKILLID_SurvivalInstinct, "TF100 Survival_Instinct" },
	{ "Seismic Impact", SKILLID_SeismicImpact, "TF103 Sesmic_Impact" },
	{ "Might of Zecram", SKILLID_RuthlessofZecram, "TF106 Ruthless_Zecram" },
	{ "Raging Strikes", SKILLID_WhirlwindFS01, "TF110 Whirlwind" },

	//Pikeman Skills - Tier 1
	{ "Pike Wind", SKILLID_PikeWind, "TP10 P_wind" },
	{ "Ice Attribute", SKILLID_IceAttribute, "TP12 I_attribute" },
	{ "Critical Hit", SKILLID_CriticalHit, "TP14 Cri_hit" },
	{ "Jumping Crash", SKILLID_JumpingCrash, "TP17 J_Crash" },

	//Tier 2
	{ "Ground Pike", SKILLID_GroundPike, "TP20 G_Pike" },
	{ "Tornado", SKILLID_Tornado, "TP23 Tornado" },
	{ "Weapon Block Mastery", SKILLID_WeaponDefenseMastery, "TP26 W_D_Mastery" },
	{ "Expansion", SKILLID_Expansion, "TP30 Expasion" },

	//Tier 3
	{ "Venom Spear", SKILLID_VenomSpear, "TP40 V_Spear" },
	{ "Vanish", SKILLID_Vanish, "TP43 Vanish", "Pk3_VANISH.tga" },
	{ "Critical Mastery", SKILLID_CriticalMastery, "TP46 C_Mastery" },
	{ "Chain Lancer", SKILLID_ChainLance, "TP50 C_Lance" },

	//Tier 4
	{ "Assassin's Eye", SKILLID_AssassinsEye, "TP60 A_Eye", "Pk4_A_EYE.tga" },
	{ "Charging Strike", SKILLID_ChargingStrike, "TP63 C_Strike" },
	{ "Vague", SKILLID_Vague, "TP66 Vague", "Pk4_VAGUE.tga" },
	{ "Shadow Master", SKILLID_ShadowMaster, "TP70 S_Master" },

	//Tier 5
	{ "Ring of Spears", SKILLID_RingofSpears, "TP100 Ring_Spears" },
	{ "Last Breath", SKILLID_LastBreath, "TP103 Focus" },
	{ "Ex-Death", SKILLID_DeathMaster, "TP106 Death_Master" },
	{ "Sinister Spin", SKILLID_Twister, "TP110 Twister" },

	//Archer Skills - Tier 1
	{ "Scout Hawk", SKILLID_ScoutHawk, "TA10 S_hawk", "Ac1_S_HAWK.tga" },
	{ "Shooting Mastery", SKILLID_ShootingMastery, "TA12 S_mastery" },
	{ "Wind Arrow", SKILLID_WindArrow, "TA14 W_arrow" },
	{ "Perfect Aim", SKILLID_PerfectAim, "TA17 P_aim" },

	//Tier 2
	{ "Dion's Eye", SKILLID_DionsEye, "TA20 D_Eye" },
	{ "Falcon", SKILLID_Falcon, "TA23 Falcon", "Ac2_FALCON.tga" },
	{ "Arrow of Rage", SKILLID_ArrowofRage, "TA26 A_Rage" },
	{ "Avalanche", SKILLID_Avalanche, "TA30 Avalanchie" },

	//Tier 3
	{ "Elemental Shot", SKILLID_ElementalShot, "TA40 E_Shot" },
	{ "Golden Falcon", SKILLID_GoldenFalcon, "TA43 G_Falcon", "Ac3_G_FALCON.tga" },
	{ "Bomb Shot", SKILLID_BombShot, "TA46 B_Shot" },
	{ "Perforation", SKILLID_Perforation, "TA50 Perforation" },

	//Tier 4
	{ "Wolverine", SKILLID_RecallWolverine, "TA60 R_Wolverin", "Ac4_R_WOLVERIN.tga" },
	{ "Evasion Mastery", SKILLID_EvasionMastery, "TA63 E_Mastery" },
	{ "Phoenix Shot", SKILLID_PhoenixShot, "TA66 P_Shot" },
	{ "Force of Nature", SKILLID_ForceofNature, "TA70 F_O_Nature", "Ac4_F_O_NATURE.tga" },

	//Tier 5
	{ "Lethal Sight", SKILLID_LethalSight, "TA100 Lethal_Sight" },
	{ "Mistral's Arrow", SKILLID_FierceWind, "TA103 Fierce_Wind" },
	{ "Blooming Lotus", SKILLID_EntalingRoots, "TA106 Entailing_Roots" },
	{ "Saggitarius Rain", SKILLID_Bombardment, "TA110 Bombardment" },

	//Assassin Skills - Tier 1
	{ "Stinger", SKILLID_Stinger, "TA10 Stingger" },
	{ "Running Hit", SKILLID_RunningHit, "TA12 R_Hit" },
	{ "Dual Wield Mastery", SKILLID_DualWieldMastery, "TA14 D_Mastery" },
	{ "Wisp", SKILLID_Wisp, "TA17 Wisp", "As1_WISP.tga" },

	//Tier 2
	{ "Venom Thorn", SKILLID_VenomThorn, "TA20 V_Throne" },
	{ "Alas", SKILLID_Alas, "TA23 Alas", "As2_ALAS.tga" },
	{ "Soul Shock", SKILLID_SoulShock, "TA26 S_Shock" },
	{ "Attack Mastery", SKILLID_AttackMastery, "TA30 A_Mastery" },

	//Tier 3
	{ "Sore Blade", SKILLID_SoreBlade, "TA40 S_Sword" },
	{ "Gust Slash", SKILLID_GustSlash, "TA43 B_Up" },
	{ "Inpes", SKILLID_Inpes, "TA46 Inpes", "As3_INPES.tga" },
	{ "Blind", SKILLID_Blind, "TA50 Blind", "As3_BLIND.tga" },

	//Tier 4
	{ "Frost Wind", SKILLID_FrostWind, "TA60 F_Wind" },
	{ "Fatal Mastery", SKILLID_FatalMastery, "TA63 F_Mastery" },
	{ "Polluted", SKILLID_Polluted, "TA66 Polluted" },
	{ "Ninja Shadow", SKILLID_NinjaShadow, "TA70 P_Shadow" },

	//Tier 5
	{ "Shunpo", SKILLID_ShadowBlink, "TS80 J_Bomb" },
	{ "Kiss of the Viper", SKILLID_KissViper, "TS83 R_Slash" },
	{ "Shade Kick", SKILLID_ViolentStub, "TS86 V_Stab" },
	{ "Shadow Storm", SKILLID_ShadowStorm, "TS90 Storm" },

	//Knight Skills - Tier 1
	{ "Sword Blast", SKILLID_SwordBlast, "MN10 S_Blast" },
	{ "Holy Body", SKILLID_HolyBody, "MN12 H_Body", "Kt1_H_BODY.tga" },
	{ "Physical Training", SKILLID_PhysicalTraining, "MN14 P_Traning" },
	{ "Double Crash", SKILLID_DoubleCrash, "MN17 D_Crash" },

	//Tier 2
	{ "Holy Valor", SKILLID_HolyValor, "MN20 H_Valor", "Kt2_H_VALOR.tga" },
	{ "Brandish", SKILLID_Brandish, "MN23 Brandish" },
	{ "Piercing", SKILLID_Piercing, "MN26 Piercing" },
	{ "Drastic Spirit", SKILLID_DrasticSpirit, "MN30 D_Spirit", "Kt2_D_SPIRIT.tga" },

	//Tier 3
	{ "Sword Mastery", SKILLID_SwordMastery, "MN40 S_Mastery" },
	{ "Divine Shield", SKILLID_DivineShield, "MN43 D_Inhalation", "Kt3_D_INHALATION.tga" },
	{ "Holy Incantation", SKILLID_HolyIncantation, "MN46 H_Incantation" },
	{ "Grand Cross", SKILLID_GrandCross, "MN50 G_Cross" },

	//Tier 4
	{ "Sword of Justice", SKILLID_SwordofJustice, "MN60 S_O_Justice" },
	{ "Godly Shield", SKILLID_GodlyShield, "MN63 G_Shield", "Kt4_G_SHIELD.tga" },
	{ "God's Blessing", SKILLID_GodsBlessing, "MN66 G_Bless", "Kt4_G_BLESS.tga" },
	{ "Divine Piercing", SKILLID_DivinePiercing, "MN70 D_Piercing" },

	//Tier 5
	{ "Holy Conviction", SKILLID_HolyConviction, "MN100 Holy_Conviction" },
	{ "Whirl Wind", SKILLID_WhirlWind, "MN103 Divine_Inquisiton" },
	{ "Glorious shield", SKILLID_GloriousShield, "MN106 Glorious_Shield" },
	{ "Divine Cross", SKILLID_DivineCross, "MN110 Divine_Cross" },

	//Atalanta Skills - Tier 1
	{ "Shield Strike", SKILLID_ShieldStrike, "MA10 S_Strike" },
	{ "Farina", SKILLID_Farina, "MA12 Farina" },
	{ "Throwing Mastery", SKILLID_ThrowingMaster, "MA14 T_Mastery" },
	{ "Bigger Spear", SKILLID_BiggerSpear, "MA17 V_Spear" },

	//Tier 2
	{ "Windy", SKILLID_Windy, "MA20 Windy", "At2_WINDY.tga" },
	{ "Twist Javelin", SKILLID_TwistJavelin, "MA23 T_Javelin" },
	{ "Soul Sucker", SKILLID_SoulSucker, "MA26 S_Sucker" },
	{ "Fire Javelin", SKILLID_FireJavelin, "MA30 F_Javelin" },

	//Tier 3
	{ "Split Javelin", SKILLID_SplitJavelin, "MA40 Split_Javelin" },
	{ "Triumph of Valhalla", SKILLID_TriumphofJavelin, "MA43 T_Of_Valhalla", "At3_T_O_VALHALLA.tga" },
	{ "Lightning Javelin", SKILLID_LightningJavelin, "MA46 L_Javelin" },
	{ "Storm Javelin", SKILLID_StormJavelin, "MA50 Storm_Javelin" },

	//Tier 4
	{ "Hall of Valhalla", SKILLID_HallofValhalla, "MA60 H_O_Valhalla", "At4_H_O_VALHALLA.tga" },
	{ "Extreme Rage", SKILLID_ExtremeRage, "MA63 X_Rage" },
	{ "Frost Javelin", SKILLID_FrostJavelin, "MA66 F_Javelin", "At4_F_JAVELIN.tga" },
	{ "Vengeance", SKILLID_Vengeance, "MA70 Vengeance" },

	//Tier 5
	{ "Nature's Call", SKILLID_SummonTiger, "MA100 S_Tiger" },
	{ "Golden Apple", SKILLID_GoldenApple, "MA103 Golden_Apple" },
	{ "Plague Javelin", SKILLID_PlagueJavelin, "MA106 Plague_Javelin" },
	{ "Triple Threat", SKILLID_ComboJavelin, "MA110 Combo_Javelin" },

	//Priestess Skills - Tier 1
	{ "Healing", SKILLID_Healing, "MP10 Healing" },
	{ "Holy Bolt", SKILLID_HolyBolt, "MP12 HolyBolt" },
	{ "Multi Spark", SKILLID_MultiSpark, "MP14 M_Spark" },
	{ "Holy Mind", SKILLID_HolyMind, "MP17 HolyMind" },

	//Tier 2
	{ "Meditation", SKILLID_Meditation, "MP20 Meditation" },
	{ "Divine Lightning", SKILLID_DivineLightning, "MP23 D_Lightning" },
	{ "Holy Reflection", SKILLID_HolyReflection, "MP26 H_Reflection", "Pr2_H_REFLECTION.tga" },
	{ "Grand Healing", SKILLID_GrandHealing, "MP30 G_Healing" },

	//Tier 3
	{ "Vigor Ball", SKILLID_VigorBall, "MP40 V_Ball" },
	{ "Resurrection", SKILLID_Resurrection, "MP43 Resurrection" },
	{ "Extinction", SKILLID_Extinction, "MP46 Extinction" },
	{ "Virtual Life", SKILLID_VirtualLife, "MP50 V_Life", "Pr3_V_LIFE.tga" },

	//Tier 4
	{ "Glacial Spike", SKILLID_GlacialSpike, "MP60 G_Spike" },
	{ "Regeneration Field", SKILLID_RegenerationField, "MP63 R_Field", "Pr4_R_FIELD.tga" },
	{ "Chain Lightning", SKILLID_ChainLightning, "MP66 C_Lightning" },
	{ "Summon Muspell", SKILLID_SummonMuspell, "MP70 S_Muspell", "Pr4_S_MUSPELL.tga" },

	//Tier 5
	{ "Ice Elemental", SKILLID_IceElemental, "MP100 Ice_Elemental" },
	{ "Ice Meteorite", SKILLID_IceMeteorite, "MP103 Ice_Meteorite" },
	{ "Heavenly Light", SKILLID_HeavenlyLight, "MP106 Heavenly_Light" },
	{ "Consecration", SKILLID_Consecration, "MP110 Consecration" },

	//Magician Skills - Tier 1
	{ "Agony", SKILLID_Agony, "MM10 Agony" },
	{ "Fire Bolt", SKILLID_FireBolt, "MM12 FireBolt" },
	{ "Zenith", SKILLID_Zenith, "MM14 Zenith", "Mg1_ZENITH.tga" },
	{ "Fire Ball", SKILLID_FireBall, "MM17 FireBall" },

	//Tier 2
	{ "Mental Mastery", SKILLID_MentalMastery, "MM20 M_Mastery" },
	{ "Watornado", SKILLID_Watornado, "MM23 Watornado" },
	{ "Enchant Weapon", SKILLID_EnchantWeapon, "MM26 E_Weapon", "Mg2_E_WEAPON.tga" },
	{ "Death Ray", SKILLID_DeathRay, "MM30 D_Ray" },

	//Tier 3
	{ "Energy Shield", SKILLID_EnergyShield, "MM40 E_Shield", "Mg3_E_SHIELD.tga" },
	{ "Diastrophism", SKILLID_Diastrophism, "MM43 Diastrophism" },
	{ "Spirit Elemental", SKILLID_SpiritElemental, "MM46 S_Elemental", "Mg3_S_ELEMENTAL.tga" },
	{ "Dancing Sword", SKILLID_DancingSword, "MM50 D_Sword", "Mg3_D_SWORD.tga" },

	//Tier 4
	{ "Fire Elemental", SKILLID_FireElemental, "MM60 F_Elemental", "Mg4_F_ELEMENTAL.tga" },
	{ "Flame Wave", SKILLID_FlameWave, "MM63 F_Wave" },
	{ "Distortion", SKILLID_Distortion, "MM66 Distortion", "Mg4_DISTORTION.tga" },
	{ "Meteorite", SKILLID_Meteorite, "MM70 Meteo" },

	//Tier 5
	{ "Wizard's Trance", SKILLID_WizardTrance, "MM100 WizardTrance" },
	{ "Flame Ball", SKILLID_StoneSkin, "MM103 Stone_Skin" },
	{ "Elemental Ray", SKILLID_RedRay, "MM106 RedRay" },
	{ "Cataclysm", SKILLID_Cataclysm, "MM110 Cataclysm" },

	//Shaman Skills - Tier 1
	{ "Dark Bolt", SKILLID_DarkBolt, "MS10 Darkbolt" },
	{ "Dark Wave", SKILLID_DarkWave, "MS12 Darkwave" },
	{ "Inertia", SKILLID_Inertia, "MS14 Curselazy" },
	{ "Inner Peace", SKILLID_InnerPeace, "MS17 I_peace" },

	//Tier 2
	{ "Spiritual Flare", SKILLID_SpiritualFlare, "MS20 S_Flare" },
	{ "Spiritual Manacle", SKILLID_SpiritualManacle, "MS23 S_Manacle" },
	{ "Chasing Hunt", SKILLID_ChasingHunt, "MS26 C_Hunt" },
	{ "Advent Migal", SKILLID_AdventMigal, "MS30 A_Migal", "Sh2_A_MIGAL.tga" },

	//Tier 3
	{ "Rainmaker", SKILLID_Rainmaker, "MS40 R_Maker", "Sh3_R_MAKER.tga" },
	{ "Phantom Call", SKILLID_PhantomCall, "MS43 L_Ghost" },
	{ "Haunt", SKILLID_Haunt, "MS46 Haunt" },
	{ "Scratch", SKILLID_Scratch, "MS50 Scratch" },

	//Tier 4
	{ "Summon Hestian", SKILLID_RecallHestian, "MS60 R_Knight", "Sh4_R_KNIGHT.tga" },
	{ "Judgement", SKILLID_Judgement, "MS63 Judge" },
	{ "Advent Midranda", SKILLID_AdventMidranda, "MS66 A_Midranda", "Sh4_A_MIDRANDA.tga" },
	{ "Mourning Pray", SKILLID_MourningPray, "MS70 M_pray" },

	//Tier 5
	{ "Creed", SKILLID_Creed, "MS80 Creed", "Sh5_CREED.tga" },
	{ "Press Deity", SKILLID_PressDeity, "MS83 P_Deity" },
	{ "Phantom Nail", SKILLID_PhantomNail, "MS86 G_Nail" },
	{ "Occult Life", SKILLID_OccultLife, "MS90 H_Regene" },

	//Other Skills
	{ "Absorption of Glory", SKILLID_AbsorptionOfGlory, "", "wa1-1.tga" },
	{ "Power Siege", SKILLID_PowerSiege, "", "wa1-3.tga" },
	{ "Evasion Adaption", SKILLID_EvasionAdaption, "", "wa1-2.tga" },
	{ "Atanasia", SKILLID_Atanasia, "", "S_Ath.tga" },
	{ "Deadly Edge", SKILLID_DeadlyEdge, "", "S_Dea.tga" },
	{ "Avail of Evasion", SKILLID_AvailofEvasion, "", "S_Eva.tga" },
	{ "Defiance Stone", SKILLID_DefianceStoneA, "", "F_C_M.tga" },
	{ "Defiance Stone", SKILLID_DefianceStoneB, "", "I_C_M.tga" },
	{ "Defiance Stone", SKILLID_DefianceStoneC, "", "L_C_M.tga" },
	{ "Might Stone", SKILLID_FighterStone, "", "Ft_R.tga" },
	{ "Might Stone", SKILLID_MechanicianStone, "", "Mc_R.tga" },
	{ "Might Stone", SKILLID_PikemanStone, "", "Pk_R.tga" },
	{ "Might Stone", SKILLID_ArcherStone, "", "Ac_R.tga" },
	{ "Might Stone", SKILLID_KnightStone, "", "Kt_R.tga" },
	{ "Might Stone", SKILLID_AtalantaStone, "", "At_R.tga" },
	{ "Might Stone", SKILLID_PriestessStone, "", "Mg_R.tga" },
	{ "Might Stone", SKILLID_MagicianStone, "", "Pt_R.tga" },
	{ "Might Stone", SKILLID_ShamanStone, "", "As_R.tga" },
	{ "Might Stone", SKILLID_MightStone, "", "Sh_R.tga" },
	{ "Eternal Life", SKILLID_EternalLife, "", "S_Ath.tga" },
	{ "Fatal Edge", SKILLID_FatalEdge, "", "S_Dea.tga" },
	{ "Avert Scroll", SKILLID_AvertScroll, "", "S_Eva.tga" },
	{ "Rivera", SKILLID_Rivera, "", "S_Lib.tga" },
	{ "Life Booster", 0x09010007, "", "Booster_01.tga" },
	{ "Stamina Booster", 0x09010008, "", "Booster_02.tga" },
	{ "Strength Booster", 0x09010009, "", "Booster_03.tga" },
	{ "Multi Booster", 0x09010030, "", "Booster_04.tga" },
};
